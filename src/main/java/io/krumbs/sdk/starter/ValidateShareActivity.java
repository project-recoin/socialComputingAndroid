...
public class ValidateShareActivity extends AppCompatActivity {
...
//              }
    ...
    public void addDataToUI(){
        ...
        adapter = new ArrayAdapter<String>(ValidateShareActivity.this, android.R.layout.simple_list_item_1,resourcesToValidate);
